...
# /voice — Design a custom anime TTS voice
...
1. **No arguments** → explain usage and show current voices:
   ...
   - Example: `/voice young Japanese girl, bright cheerful anime voice, fast excited delivery, slight giggle --activate`
...
5. **Plain description** (any other input) → this is a voice prompt:
   ...
   - On success, report the new voice slug + voice_id, and tell them how to activate it (`/voice --use <slug>`) if they didn't pass `--activate`.
